...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="bg-red-50 border-b border-red-200 text-center py-2 px-4">
        <p className="text-sm text-red-800">
          <strong>Криза?</strong> Обадете се на Националната линия: 
          <a href="tel:0800201000" className="font-semibold hover:underline ml-1">0800 20 100</a>
          <span className="text-red-600 ml-2">(24/7, безплатна)</span>
        </p>
      </div>
                  ...
                  <Button
                    ...
                    className={
                      action.variant === 'emergency'
                        ...
                        : 'border-soft-blue/30 text-soft-blue hover:bg-soft-blue/10'
                    }
                    asChild
                  >
                    <a 
