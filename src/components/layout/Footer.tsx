    ...
    <footer className="bg-charcoal text-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="container mx-auto px-4 py-12">
          {/* Newsletter Section */}
          <div className="bg-gradient-to-r from-soft-blue/20 to-sky-blue/20 rounded-2xl p-8 mb-12 border border-white/10">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold mb-2">Останете в контакт</h3>
              ...
              <div>
                {isSubscribed ? (
                  <div className="bg-green-500/20 border border-green-400/30 rounded-lg p-4 text-center">
                    ...
                    <p className="text-green-100 font-medium">Благодарим за абонамента!</p>
                    <p className="text-green-200 text-sm">Ще получите потвърждение по имейл.</p>
                  </div>
                ) : (
                  <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                    <div className="flex space-x-2">
                      <input
                        ...
                        className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-lg placeholder-blue-200 text-white focus:outline-none focus:ring-2 focus:ring-white/30"
                        required
                      />
                      <Button 
                        type="submit" 
                        disabled={isSubmitting}
                        className="bg-white text-soft-blue hover:bg-gray-100 px-6"
                      >
                        {isSubmitting ? (
          ...
          <div className="grid lg:grid-cols-4 gap-8 mb-12">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-12 h-12 bg-gradient-to-br from-soft-blue to-sky-blue rounded-xl flex items-center justify-center shadow-lg">
                  <Heart className="w-6 h-6 text-white" />
                </div>
                <div>
                  <div className="text-xl font-bold">Олга Колева</div>
                  <div className="text-gray-400 text-sm">Психолог & Терапевт</div>
                </div>
              </div>
              ...
              <div className="space-y-2 mb-6">
                <h4 className="text-sm font-semibold text-white mb-3">Сертификати</h4>
            ...
            <div>
              <h3 className="font-semibold text-lg mb-6 flex items-center">
                <Heart className="w-4 h-4 mr-2 text-soft-blue" />
                Услуги
              </h3>
            ...
            <div>
              <h3 className="font-semibold text-lg mb-6 flex items-center">
                <Phone className="w-4 h-4 mr-2 text-steel-blue" />
                Контакт
              </h3>
              ...
              <div className="space-y-2">
                <h4 className="text-sm font-semibold text-white">Правни документи</h4>
          ...
          <div className="bg-red-500/20 border border-red-400/30 rounded-xl p-6 mb-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-red-100 mb-2">Кризисна помощ 24/7</h3>
                ...
                <div className="flex flex-wrap gap-4 text-sm">
                  ...
                  <a 
                    href="tel:+359888494533" 
                    className="border border-red-400 text-red-200 hover:bg-red-500/20 px-4 py-2 rounded-lg transition-colors"
                  >
                    Олга Колева
                  </a>
                </div>
